...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "driverportal/test/integration/FirstJourney",
    "driverportal/test/integration/VehiclesListJourney",
    "driverportal/test/integration/VehiclesObjectPageJourney",
    "driverportal/test/integration/FuelLogsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
